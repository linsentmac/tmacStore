...
import com.lenovo.smartShop.view.SearchView;
...
public class SearchActivity extends Activity implements SearchView.SearchViewListener {
     ...
     * 数据库数据，总数据
     */
    private List<AppListBean.DataBean.DatalistBean> dbData;
     ...
     * 搜索结果的数据
     */
    private List<AppListBean.DataBean.DatalistBean> resultData;
    ...
    private void initViews() {
        ...
        lvResults.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Intent intent = new Intent(SearchActivity.this, AppDetailInfoActivity.class);
    ...
    private void getDbData() {
        ...
        dbData.addAll(myApplication.getDataList());
    }
    ...
    private void getAutoCompleteData(String text) {
        if (autoCompleteData == null) {
            ...
            for (int i = 0, count = 0; i < dbData.size()
                    && count < hintSize; i++) {
                if (dbData.get(i).getName().toLowerCase().contains(text.trim().toLowerCase())) {
    ...
    private void getResultData(String text) {
        ...
        if (resultAdapter == null) {
            resultAdapter = new SearchAdapter(this, resultData, R.layout.list_item, true);
        } else {
